...
<template>
    <div v-show="isShow" class="modal" id="modal-1" aria-hidden="true">
        <div class="modal__overlay" tabindex="-1" data-micromodal-close>
            <div class="modal__container w-3/4" role="dialog" aria-modal="true" aria-labelledby="modal-1-title">
                            ...
                            <tbody>
                                <tr v-for="customer in customers.value.data" :key="customer.id">
                                    <td class="border-b-2 border-gray-200 px-4 py-3">
                                        <button type="button"
                                            @click="setCustomer({id: customer.id, kana: customer.kana})">{{ customer.id
                                            }}</button>
                                    </td>
    ...
    <button @click="searchCustomers" type="button" ata-micromodal-trigger="modal-1"
